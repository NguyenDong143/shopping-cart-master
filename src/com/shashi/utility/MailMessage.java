...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Welcome to THE COFFEE SHOP</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thanks for singing up with THE COFFEE SHOP.<br>"
				+ "We are glad that you choose us. We invite you to check out our latest collection of new products."
				+ "<br>We are providing upto 60% OFF on most of the products. So please visit our site and explore the collections."
				+ "<br><br>Our NHOM 08 is growing in a larger amount these days and we are in high demand so we thanks all of you for "
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at THE COFFEE SHOP";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with THE COFFEE SHOP!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">THE COFFEE SHOP.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at THE COFFEE SHOP";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with THE COFFEE SHOP!" + "      <br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">THE COFFEE SHOP.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
